...
The 20-character minimum for names is from the requirements. Honestly, "John Smith" is only 10 characters and would fail this check. In a real app I'd use 3 to 50 instead, but I kept it as specified.